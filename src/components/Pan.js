...
const Pan = () => {
  ...
  return (
    <div>
        <Speech data="Please upload your Pan Card and Image"/>
      <input className='btn-f' type="file" accept="image/*" onChange={handleImageUpload} />
      <Link to='/aadhar'><button className='btn'>Previous</button></Link>
      <button className='btn' onClick={() => setIsCapturing(true)}>Capture Image</button>
      <Link to='/salary'><button className='btn'>Next</button></Link>
